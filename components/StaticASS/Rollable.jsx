  ...
  return (
    ...
    <main className="bg-neutral-50">
      <div className="h-[100dvh] flex items-center justify-center">
        ...
        <div id="item" className="items-center flex justify-center h-48 w-48 rounded-3xl shadow-[0px_0px_0px_1px,0px_1px_1px_-0.5px,0px_3px_3px_-1.5px,0px_6px_6px_-3px,0px_12px_12px_-6px,0px_24px_24px_-12px] shadow-black/[0.06] bg-gradient-to-b from-white to-black/[0.02]">
