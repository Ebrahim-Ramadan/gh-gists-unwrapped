...
const Ass = () => {
  ...
  <span
        aria-hidden="true"
        className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-6xl font-semibold"
      >
        ...
        <main className="pb-96">
          <section className="min-h-screen grid place-items-center px-4">
            <ul className="grid grid-cols-2 gap-x-8 gap-y-1 text-center text-2xl sm:text-4xl md:text-5xl font-medium leading-none">
              ...
              <li className="text-right">Neo </li>
              <li className="text-left">Fiona </li>
              <li className="text-right">Rex </li>
              <li className="text-left">Marah </li>
              <li className="text-right"> Rowe</li>
              <li className="text-left">Maz </li>
              <li className="text-right"> Beck</li>
              <li className="text-left"> Const</li>
            </ul>
          </section>
        </main>
      </div>
